...
internal sealed class IncidentPipeline(ModelSettings settings, EvidenceStore store)
{
    ...
    {
        // TODO 2: Expose the evidence reader to the agent as a tool named read_evidence.
        throw new NotImplementedException("TODO 2: register the evidence tool");
    }
    ...
    private async Task<IReadOnlyList<ExtractedClaim>> ExtractAsync(AIAgent agent, string sourceId, string content)
    {
        ...
        // TODO 3: Ask the agent for typed claims and attach the source id we already know.
        throw new NotImplementedException("TODO 3: run the typed extraction step");
    }
