...
| 18–26 | **The dataset and Gather** · CP-03 `dotnet run -- "…intersection crashes from 2012."` (model fills the filter, C# clamps it), then `-- "Find cyclist crashes."` → 0 records | attendees run | slides 22–26 · 8 records · `isEmpty: true` |
