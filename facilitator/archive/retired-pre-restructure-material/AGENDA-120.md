...
| 45–62 | **TODO 2 + 3 — the model's one job** | Register the tool; connect typed extraction. Demonstrate the combined-call failure live (see [DEMOS.md](../../workshop/DEMOS.md), demo 3) — 1.4s and an empty array. Discuss what that implies for agent design on small models. |
