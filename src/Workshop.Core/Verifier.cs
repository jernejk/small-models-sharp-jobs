...
public static partial class Verifier
{
    ...
    {
        // >>> TODO 4 | The quote must really occur in the cited source. Compare normalized text. | STUB: throw new NotImplementedException("TODO 4: check the quote occurs in the cited source");
