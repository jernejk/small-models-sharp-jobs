...
/// <summary>What Analyse produces. It only ever sees records that already cleared the selection gate.</summary>
internal sealed record CrashAnalysis(string Finding, string[] Actions, string[] Questions, int Confidence);
