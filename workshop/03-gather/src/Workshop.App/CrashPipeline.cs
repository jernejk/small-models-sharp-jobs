...
internal sealed class CrashPipeline(ModelSettings settings)
{
    ...
    /// <summary>CP-03 turns a question into untrusted filter data before C# gathers local records.</summary>
    public async Task<QueryCheck> InterpretQueryAsync(string question, CancellationToken cancellationToken = default)
    {
        // TODO: CP-03 call a tool-free QueryAgent and return its typed QueryFilter.
        return new QueryCheck("", null, TimeSpan.Zero);
    }
